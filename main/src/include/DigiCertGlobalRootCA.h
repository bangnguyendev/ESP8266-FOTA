// DigiCert Global G2 TLS RSA SHA256 2020 CA1 - Valid until: 29/Mar/2031
...
// Run terminal:
// openssl s_client -connect raw.githubusercontent.com:443 < /dev/null 2>/dev/null | openssl x509 -fingerprint -noout -sha1
// output:
